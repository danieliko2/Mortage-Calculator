...
function addTamhil(){
    var ul = document.getElementById("tamhilimNavbar");  // create new navbar item
    ...
    var newDiv = document.createElement("div"); // create new Tamhil
    ...
    $(oldDiv).after(newDiv);
    for (let i=1; i< liNum; i++){ // Set all tamhils to invisible
        document.getElementById(`tamhil${i}NavItem`).style.backgroundColor = "grey";
        document.getElementById(`tamhil${i}`).style.display = "none ";
    }
    document.getElementById(`tamhil${liNum}`).style.display = "block"; // active tamhil visible
    document.getElementById(`tamhil${liNum}NavItem`).style.backgroundColor = "rgb(70, 69, 69)";
